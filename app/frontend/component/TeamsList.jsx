    ...
    const fetchTeams = async () => {
      try {
        ...
        const formattedTeams = response.data.teams.map((team) => {
          ...
          const logo =
            team.strTeam === "Wydad Casablanca" ? logos : team.strBadge;
      ...
      "English Premier League": [
        {
          team: {
            id: "133604",
            name: "Arsenal",
            logo: "https://www.thesportsdb.com/images/media/team/badge/xtwxyt1421431860.png",
          },
        },
        {
          team: {
        ...
        },
        {
          team: {
            ...
            logo: "https://www.thesportsdb.com/images/media/team/badge/qttvpr1448813355.png",
          },
        },
        {
          team: {
            ...
            logo: "https://www.thesportsdb.com/images/media/team/badge/trwqyw1448813215.png",
          },
        },
      ],
      "La Liga": [
        {
          team: {
            id: "133738",
            name: "Barcelona",
            logo: "https://www.thesportsdb.com/images/media/team/badge/xxvryt1448813219.png",
          },
        },
        {
          team: {
            id: "133739",
            name: "Real Madrid",
            logo: "https://www.thesportsdb.com/images/media/team/badge/qzqkst1448813215.png",
          },
        },
        {
          team: {
        ...
        },
        {
          team: {
            id: "133741",
            name: "Sevilla",
            logo: "https://www.thesportsdb.com/images/media/team/badge/rrrrtt1448813215.png",
          },
        },
        {
          team: {
            id: "133742",
            name: "Valencia",
            logo: "https://www.thesportsdb.com/images/media/team/badge/tyttyy1448813215.png",
          },
        },
      ],
      Bundesliga: [
      ...
      "Moroccan League": [
        {
          team: {
            ...
            logo: "https://www.thesportsdb.com/images/media/team/badge/wydad.png",
          },
        },
        {
          team: {
            ...
            logo: "https://www.thesportsdb.com/images/media/team/badge/raja.png",
          },
        },
        {
          team: {
            id: "136159",
            name: "AS FAR",
            logo: "https://www.thesportsdb.com/images/media/team/badge/far.png",
          },
        },
      ],
    };
      ...
      <div className="selected-teams">
        {homeTeam && (
          <div className="selected-team">
            ...
            <p>{homeTeam.name}</p>
            {homeTeam.stadium && (
              <p className="team-stadium">{homeTeam.stadium}</p>
            )}
          </div>
        )}
        ...
        {awayTeam && (
          <div className="selected-team">
            ...
            <p>{awayTeam.name}</p>
            {awayTeam.stadium && (
              <p className="team-stadium">{awayTeam.stadium}</p>
            )}
          </div>
        )}
      </div>
